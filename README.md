...
python src/inference.py     --model_path ~/.cache/huggingface/hub/models--Diankun--Spatial-MLLM-v1.1-Instruct-135K/snapshots/main     --model_type spatial-mllm     --text "How many chair(s) are in this room?\nPlease answer the question using a single word or phrase."
